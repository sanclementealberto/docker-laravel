...
<?php endif; ?>
    <h2 class="text-center">Login taller</h2>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['href' => ''.e(route('register')).'','class' => 'ms-4 text-sm text-white bg-black px-4 py-2 rounded-md  focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('register')).'','class' => 'ms-4 text-sm text-white bg-black px-4 py-2 rounded-md  focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500']); ?>
